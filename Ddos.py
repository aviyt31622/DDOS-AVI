...
def get_Typer():
	...
	global fake_ip
	global hides
	optp = OptionParser(add_help_option=False,epilog="AVIYT DDos")
...
def usage1():
	...
	usage : python Ddos.py [-i] [-p] [-l]
            ...
            -d : Hide message
	example :
	    python Ddos.py -i 92.204.214.136 -p 80 -l 2"""
    md = Markdown(MARKDOWN)
    console.print(md,style="bold green")
    #sys.exit()
...
def usage3():
    ...
    github : https://github.com/aviyt31622
    Tool Information : This Tool Made Only For Fun
"""
    md = Markdown(MARKDOWN)
    console.print(md,style="bold green")
